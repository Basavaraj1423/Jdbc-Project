...
import static com.doctorapp.util.DatabaseQuerries.*;
...
public class DoctorRepositoryImpl implements IDoctorRepository {
    ...
    public void addDoctor(Doctor doctor) {
        try {
            ...
            PreparedStatement statement = connection.prepareStatement(INSERTQUERRY);
    ...
    public void deleteDoctor(int doctorId) {
        try {
            Connection connection = DoctorDatabase.openConnection();
            PreparedStatement statement = connection.prepareStatement(DELETEQUERRY);
...
//doctor_name,speciality,fees,ratings,experience
    ...
    public List<Doctor> findAll() {
        ...
        try {
            Connection connection = DoctorDatabase.openConnection();
            PreparedStatement statement = connection.prepareStatement(FINDALLQUERRY);
            ResultSet resultSet = statement.executeQuery();
            while (resultSet.next()) {
    ...
    public List<Doctor> findBySpeciality(String speciality) throws DoctorNotFoundException {
        ...
        try {
            Connection connection = DoctorDatabase.openConnection();
            PreparedStatement statement = connection.prepareStatement(FINDBYSPECIALITY);
    ...
    public List<Doctor> findBySpecialityAndExperience(String speciality, int experience) throws DoctorNotFoundException {
        ...
        try {
            Connection connection = DoctorDatabase.openConnection();
            PreparedStatement statement = connection.prepareStatement(FINDBYSPECIALITYANDEXPERIENCE);
            statement.setString(1, speciality);
    ...
    public List<Doctor> findBySpecialityAndLessFees(String speciality, double fees) throws DoctorNotFoundException {
        ...
        try {
            Connection connection = DoctorDatabase.openConnection();
            PreparedStatement statement = connection.prepareStatement(FINDBYSPECIALITYANDLESSFEES);
            statement.setString(1, speciality);
    ...
    public List<Doctor> findBySpecialityAndRatings(String speciality, int ratings) throws DoctorNotFoundException {
        ...
        try {
            Connection connection = DoctorDatabase.openConnection();
            PreparedStatement statement = connection.prepareStatement(FINDSPECIALITYANDRATINGS);
            statement.setString(1, speciality);
