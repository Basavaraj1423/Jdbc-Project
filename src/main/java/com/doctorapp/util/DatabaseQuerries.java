...
public class DatabaseQuerries {
    public static final String INSERTQUERRY =
            "INSERT INTO doctor(doctor_name,speciality,fees,ratings,experience)values(?,?,?,?,?)";
    public static final String UPDATEQUERRY =
            "UPDATE doctor SET fees=? where doctor_id = ?";
    public static final String DELETEQUERRY =
            "DELETE FROM doctor WHERE doctor_id=?";
    public static final String FINDALLQUERRY =
            "SELECT * FROM doctor";
    public static final String FINDBYSPECIALITY =
            "SELECT * FROM doctor WHERE speciality=?";
    public static final String FINDBYSPECIALITYANDEXPERIENCE =
            "SELECT * FROM doctor WHERE speciality=? AND experience >=?";
    public static final String FINDSPECIALITYANDRATINGS =
